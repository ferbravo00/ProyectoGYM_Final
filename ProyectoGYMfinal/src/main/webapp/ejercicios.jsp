    ...
    <main>
        ...
        <div class="container h-100 py-4">
            <div class="d-flex justify-content-center h-100">
                <div class="searchbar ">
                    <form method="post">
                        <input class="search_input " type="text" name="keyword" placeholder="Buscar...">
...
<!--                <?php
                    ...
                    foreach($bd->query("SELECT * FROM ejercicio LIMIT 12;") as $alumno)
				{*/
                    require ('conexion.php');
                    
                    if ($_POST) {
                        $keyword = $_POST['keyword'];
                        $sql = $bd -> prepare("SELECT * FROM ejercicio WHERE nombre LIKE :keyword OR parte LIKE :keyword");
                        $sql->execute(array(':keyword' => "%$keyword%"));
                        $resultado=$sql->fetchAll(PDO::FETCH_OBJ);
                      } else {
                        $sql = $bd -> prepare("SELECT * FROM ejercicio LIMIT 12;");
                        $sql->execute();
                        $resultado=$sql->fetchAll(PDO::FETCH_OBJ);
                      }
                ...
                <div class="col-lg-3 col-md-6 mb-5">
                    <div class="card border-0 bg-secondary text-center text-white shadow p-2 bg-body rounded">
                        <img class="card-img-top" src="img/${ejercicios.foto}" alt="">
        ...
        <div class="container pt-5 team">
            <div class="row">
                ...
                <div class="d-grid gap-2 col-6 mx-auto shadow p-3 mb-5 bg-body rounded">
                    <form action="ejercicios?accion=insertar" method="POST">
                        ...
                        <input class="form-control my-2" REQUIRED name="imagen" type="file" id="formFile">
