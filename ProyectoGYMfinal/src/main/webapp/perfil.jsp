            ...
            <nav class="navbar navbar-expand-xl bg-none navbar-dark py-3">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto p-4 bg-secondary">
                        ...
                        <a href="usuarios?accion=editar" class="nav-item nav-link me-4 fs-5 active">Perfil <i
            ...
            <div class="row shadow p-3 mb-5 bg-body rounded">
                <div class="d-grid gap-2 col-6 mx-auto text-center">
                    ...
                    <div class="row g-3 mt-3">
                        <div class="col" href="usuarios?accion=seguidores">
                            <span>${seguidores}</span>
                            <span>Seguidores</span>
                        </div>
                        <div class="col" href="usuarios?accion=seguidos">
                            <span>${seguidos}</span>
                            <span>Seguidos</span>
                        </div>
                    </div>
